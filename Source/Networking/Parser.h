...
enum NetworkChunkEnums { NCE_END, NCE_NEW_CONNECTION, NCE_NEW_PLAYER, NCE_PLAYER, NCE_REMOVE_PLAYER, NCE_TOO_MANY_PLAYERS, NCE_ALREADY_JOINED, NCE_LOBBY, NCE_PLAYER_INPUT, NCE_PLAYER_GREETING, NCE_LOOKUP_PLAYER, NCE_MAP, NCE_START_GAME_TIMER, NCE_LOBBY_PLAYER_SYNC, NCE_LOBBY_STATE_SYNC };
